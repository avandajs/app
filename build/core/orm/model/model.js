...
export default class Model {
    constructor() {
        ...
        this.connection = Connection({
            dbDialect: Env.get('DB_DRIVER', 'mysql'),
    ...
    sum(column) {
        this.tempSelectColumn = fn('SUM', col(column));
        return this;
    }
    as(alias) {
    ...
    whereRaw(condition) {
        return this._where(condition, Op.and, true);
    }
    orWhere(condition) {
    ...
    _where(condition, operand = Op.and, isRaw = false) {
        this.closeQuery();
    ...
    updateWhereClauses(operand, condition) {
        var _a;
        if (this.whereClauses && operand == Op.or && typeof ((_a = this.whereClauses) === null || _a === void 0 ? void 0 : _a.hasOwnProperty(Op.and))) {
            this.whereClauses = {
                [operand]: [...this.whereClauses[Op.and]]
            };
        }
